"""
Шаблон для создания документов в стиле Кузнецова.
...
def add_section_heading(text, size=14):
    ...
    size=14 для основных разделов (1. 2. 3.)
    size=13 для блоков (А. Б. В.)
    size=12 для подразделов (1.1. 1.2. или названий исков)
    """
    p = doc.add_paragraph()
...
def add_numbered_item(text, indent_cm=1.5):
    ...
    Формат текста: 1) текст, 2) текст и т.д.
    """
    p = doc.add_paragraph()
...
def add_table(data):
    ...
    Шапка: тёмно-синий фон, белый текст.
...
# 
# Типичная структура документа в стиле Кузнецова:
#   1. Стратегические цели
#   2. План достижения целей (с подразделами)
#   3. Анализ последствий (налоговые, правовые и т.д.)
